...
#define EIC_CHARGER_DETECT		0
#define EIC_POWER_PBINT2        1
#define EIC_POWER_PBINT         2
#define EIC_AUD_HEAD_BUTTON     3
#define EIC_CHG_CV_STATE        4
#define EIC_AUD_HEAD_INST       5
#define EIC_VCHG_OVI            6
#define EIC_VBAT_OVI            7
#define EIC_AUD_HEAD_INST2      8
...
#define LTE_TOTAL_SIZE		(SZ_1M * 66 + SZ_512K)
